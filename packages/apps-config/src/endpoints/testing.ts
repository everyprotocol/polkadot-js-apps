...
export const testChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    info: 'every',
    providers: {
      Every: 'wss://testnet.every.network'
    },
    text: 'Every Testnet',
    ui: {
      color: '#00DDFF',
