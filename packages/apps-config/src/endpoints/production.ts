...
export const prodChains: Omit<EndpointOption, 'teleport'>[] = [
  ...
  },
  {
    info: 'every',
    providers: {
      Every: 'wss://mainnet.every.network'
    },
    text: 'Every',
    ui: {
      color: '#00DDFF',
